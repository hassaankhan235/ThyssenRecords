...
function SerTechAllSA(props) {
  ...
  {data && data.AllSerSAByTechnicianID.map(tbt => {
      ...
      return(<tr>
        ...
        <td> {loading? <Loader /> : tbt.data.type} </td>
